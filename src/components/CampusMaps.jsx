      ...
      <div className="relative h-[500px] sm:h-[600px] lg:h-[700px] rounded-3xl overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
        ...
        {buildings.map((building) => (
          <button
            ...
            className={`absolute w-40 h-28 rounded-2xl backdrop-blur-md transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-xl ${
        ...
        {/* Campus Overview */}
        <div className="absolute bottom-5 left-5 bg-slate-900/90 backdrop-blur-md border border-slate-700 rounded-2xl p-4 w-64">
